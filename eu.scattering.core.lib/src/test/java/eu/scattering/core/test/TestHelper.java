...
public class TestHelper {
    ...
    public static FPoint getRandFPoint(FPoint... exc) {
        ...
        main:
        while (true) {
            var candidate =  factory.random().mutate().withinRange(factory.getFPoint(), range3D);
    ...
    public static FComplex getRandFComplex(FComplex... exc) {
        ...
        main:
        while (true) {
            var candidate =  factory.random().mutate().withinRange(factory.getFComplex(), range2D);
    ...
    public static FQuaternion getRandFQuaternion(FQuaternion... exc) {
        ...
        main:
        while (true) {
            var candidate =  factory.random().mutate().withinRange(factory.getFQuaternion(), range4D);
