...
public class FModelCCBallisticTest {
    ...
    class Aggregation3DTest {
        ...
        void randomization() {
            ...
            FModelCC fModelA = factoryA.models().cc().ballistic(fAggregateA);
            ...
            FModelCC fModelB = factoryB.models().cc().ballistic(fAggregateB);
    ...
    class Aggregation2DTest {
        ...
        void randomization() {
            ...
            FAggregate fAggregateA = factoryA.aggregates().templates().polydisperse(size, 10, 1);
            FModelCC fModelA = factoryA.models().cc().ballistic(Dimension.D2, fAggregateA);
            fModelA.setSymmetry(false);

            ScatterFactory factoryB = ScatterFactoryDef.create(123);

            FAggregate fAggregateB = factoryB.aggregates().templates().polydisperse(size, 10, 1);
            FModelCC fModelB = factoryB.models().cc().ballistic(Dimension.D2, fAggregateB);
            fModelB.setSymmetry(false);
