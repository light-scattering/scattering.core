...
public class FRayRotateTest {
    ...
    void rotateQtSimple() {
        ...
        rot.mutate().aroundQt(fVector, fRay, Math.PI * 0.5);
    ...
    void rotateQtBelowBase() {
        ...
        rot.mutate().aroundQt(fVector, fRay, Math.PI);
    ...
    void rotateRgSimple() {
        ...
        rot.mutate().aroundRg(fVector, fRay, Math.PI * 0.5);
    ...
    void rotateRgBelowBase() {
        ...
        rot.mutate().aroundRg(fVector, fRay, Math.PI);
