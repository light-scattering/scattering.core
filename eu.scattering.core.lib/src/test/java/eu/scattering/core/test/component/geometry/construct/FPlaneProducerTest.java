...
public class FPlaneProducerTest {
    ...
    void iterateFixed() {
        ...
        for (FPlane construct : producer.getListFixed(8)) {
    ...
    void iterateRandom() {
        ...
        List<FPlane> results = producer.getListRandomized(60);
    ...
    void stream() {
        ...
        List<FPlane> results = producer.stream().limit(60).collect(Collectors.toList());
    ...
    void produceWithAspect() {
        ...
        Assertions.assertAll("Validate FPlane values",
                () -> assertEquals(1, resultA.getRefOrigin().getMagnitude(),
                        epsilon, "The FPlane A magnitude is erroneous"),
                () -> assertEquals(1, resultB.getRefOrigin().getMagnitude(),
                        epsilon, "The FPlane B magnitude is erroneous"),
