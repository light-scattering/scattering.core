...
public class FLineProducerTest {
    ...
    void iterateFixed() {
        ...
        for (FLine construct : producer.getListFixed(8)) {
    ...
    void iterateRandom() {
        ...
        List<FLine> results = producer.getListRandomized(60);
    ...
    void stream() {
        ...
        List<FLine> results = producer.stream().limit(60).collect(Collectors.toList());
