...
public class FAggregateTest {
    ...
    class FAggregateCoreTest {
        ...
        void parseJSONB() {
            FAggregate fAggregate = factory.aggregates().templates().monodisperse(10, 1).addFBuffer(10).addFMaterial();
    ...
    class FAggregateAdvancedTest {
        ...
        void getDiameter() {
            FAggregate fAggregate = factory.aggregates().geometries().grid1D(10);
        ...
        void projectCompositeA() {
            FAggregate aggregateA = factory.aggregates().geometries().fullSphere(3);
            FAggregate aggregateB = factory.aggregates().geometries().grid2D(5, 5);

            aggregateA.setParticleEpsilon(1);

            aggregateA.getRefParticles().translate(factory.random().engine().nextDoubleOnSphere(100));
        ...
        void translateFVectorWithFVector() {
            ...
            Assertions.assertAll("Validate FAggregate",
                    () -> assertTrue(fAggregate.getRefParticles().asList().getFirst().isExact(factory.getFSphere(3, 2, 3))),
                    () -> assertTrue(fAggregate.getRefParticles().asList().get(1).isExact(factory.getFSphere(1, 4, 3))),
                    () -> assertTrue(fAggregate.getRefParticles().asList().get(2).isExact(factory.getFSphere(1, 2, 5)))
            );
        }
        ...
        void scale() {
            ...
            FAggregate fAggregate = factory.aggregates().geometries().grid3D(4, 5, 6);
        ...
        void setRadiusWithPrimitives() {
            ...
            FAggregate fAggregate = factory.aggregates().templates().monodisperse(quantity, 10);
            FModel fModel = factory.models().pc().tunable(fAggregate, 1.8, 1.6);
        ...
        void pcaAggregate() {
            FAggregate aggregate = factory.aggregates().templates().polydisperse(100, 10, 1);
            FModel model = factory.models().cc().ballistic(aggregate);
    ...
    class FAggregateTopologyTest {
        ...
        class BoxCountingTest {
            ...
            void getBoxDimension() {
                ...
                double dim14 = fAggregate14.getFractalDimension(FractalDimension.BC_BASELINE);
                double dim18 = fAggregate18.getFractalDimension(FractalDimension.BC_BASELINE);
                double dim22 = fAggregate22.getFractalDimension(FractalDimension.BC_BASELINE);
            ...
            void getBoxDimensionBasicGeometry() {
                ...
                double dim1d = fAggregate1d.getFractalDimension(FractalDimension.BC_BASELINE);
                double dim2d = fAggregate2d.getFractalDimension(FractalDimension.BC_BASELINE);
                double dim3d = fAggregate3d.getFractalDimension(FractalDimension.BC_BASELINE);
            ...
            void getBoxDimensionBasicGeometryAsymmetric() {
                FAggregate fAggregate2d = factory.aggregates().geometries().grid2D(15, 17);
                FAggregate fAggregate3d = factory.aggregates().geometries().grid3D(15, 17, 19);
        ...
        class DensityCorrelationTest {
            ...
            void getDensityDimension() {
                ...
                double dim14 = fAggregate14.getFractalDimension(FractalDimension.DC_RESTRICTED);
                double dim18 = fAggregate18.getFractalDimension(FractalDimension.DC_RESTRICTED);
                double dim22 = fAggregate22.getFractalDimension(FractalDimension.DC_RESTRICTED);
            ...
            void getDensityDimensionBasicGeometry() {
                ...
                double dim3d = fAggregate3d.getFractalDimension(FractalDimension.DC_RESTRICTED);
            ...
            void getDensityDimensionBasicGeometryTranslated() {
                ...
                fAggregate1d.getRefParticles().translate(factory.random().engine().nextDoubleInSphere(5));
                fAggregate2d.getRefParticles().translate(factory.random().engine().nextDoubleInSphere(5));
                fAggregate3d.getRefParticles().translate(factory.random().engine().nextDoubleInSphere(5));
        ...
        class MassRadiusTest {
            ...
            void getMassDimension() {
                ...
                double dim14 = fAggregate14.getFractalDimension(FractalDimension.MR_RESTRICTED);
                double dim18 = fAggregate18.getFractalDimension(FractalDimension.MR_RESTRICTED);
                double dim22 = fAggregate22.getFractalDimension(FractalDimension.MR_RESTRICTED);
            ...
            void getMassDimensionBasicGeometry() {
                ...
                double dim3d = fAggregate3d.getFractalDimension(FractalDimension.MR_RESTRICTED);
        ...
        class FractalPrefactorTest {
            ...
            void df10() {
                int size = 100;
                FAggregate aggregate = factory.aggregates().geometries().grid1D(size);
            ...
            void df20() {
                int size = 25;
                FAggregate aggregate = factory.aggregates().geometries().hex2D(size);
            ...
            void df30() {
                int size = 15;
                FAggregate aggregate = factory.aggregates().geometries().hex3D(size);
