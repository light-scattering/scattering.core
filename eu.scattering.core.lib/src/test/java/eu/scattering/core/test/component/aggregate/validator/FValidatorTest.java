...
public class FValidatorTest {
    ...
    class FValidatorOverlapTest {
        ...
        void dimensionCorrelationPC() {
            ...
            FModelPC fModel = factory.getFModelContext().pc().ballistic(fAggregate);
            FValidatorFractalDimension fValidator = factory.getFValidatorContext().fractalDimension(FractalDimension.CD_RESTRICTED, 2.5, 0.3);
        ...
        void dimensionCorrelationCC() {
            ...
            FModelCC fModel = factory.getFModelContext().cc().ballistic(fAggregate);
            FValidatorFractalDimension fValidator = factory.getFValidatorContext().fractalDimension(FractalDimension.CD_RESTRICTED, 2.2, 0.3);
