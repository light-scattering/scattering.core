...
public class FValidatorTest {
    ...
    class FValidatorFractalDimensionTest {
        ...
        void dimensionBoxPC() {
            ...
            FModelPC fModel = factory.getFModelContext().pc().ballistic(fAggregate);
            FValidatorFractalDimension fValidator = factory.getFValidatorContext().fractalDimension(FractalDimension.BOX, 2.5, 0.3);
        ...
        void dimensionBoxCC() {
            ...
            FModelCC fModel = factory.getFModelContext().cc().ballistic(fAggregate);
            FValidatorFractalDimension fValidator = factory.getFValidatorContext().fractalDimension(FractalDimension.BOX, 2.2, 0.3);
