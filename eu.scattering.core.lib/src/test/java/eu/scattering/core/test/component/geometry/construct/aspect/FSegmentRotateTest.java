...
public class FSegmentRotateTest {
    ...
    void rotateQtSimple() {
        ...
        rot.mutate().aroundQt(fVector, fSegment, Math.PI * 0.5);
    ...
    void rotateQtBelowBase() {
        ...
        rot.mutate().aroundQt(fVector, fSegment, Math.PI);
    ...
    void rotateRgSimple() {
        ...
        rot.mutate().aroundRg(fVector, fSegment, Math.PI * 0.5);
    ...
    void rotateRgBelowBase() {
        ...
        rot.mutate().aroundRg(fVector, fSegment, Math.PI);
