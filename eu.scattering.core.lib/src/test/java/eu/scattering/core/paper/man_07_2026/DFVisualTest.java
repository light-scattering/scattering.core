...
public class DFVisualTest {
    ...
    class PL {
        ...
        void visualPCPL() {
            ...
            String geometry = factory.export().toBasic(fAggregate, ExBasic.MULTISPHERE);
    ...
    class DC {
        ...
        void visualDC() {
            ...
            String model = factory.export().toPovRay(fAggregate, ExPovRay.REFERENCE);
    ...
    class BC {
        ...
        void visio() {
            ...
            String modelA = factory.export().toPovRay(fAggregate, ExPovRay.BOUNDARY);

            assertFalse(modelA.isEmpty());

            String modelB = factory.export().toPovRay(fAggregate, ExPovRay.BOX_COUNTING);
    ...
    class Geometry {
        ...
        void basic() {
            ...
            String fModel1d = factory.export().toPovRay(fAggregate1d, ExPovRay.BOUNDARY);
            assertFalse(fModel1d.isEmpty());

            String fModel2d = factory.export().toPovRay(fAggregate2d, ExPovRay.BOUNDARY);
            assertFalse(fModel2d.isEmpty());

            String fModel3d = factory.export().toPovRay(fAggregate3d, ExPovRay.BOUNDARY);
