...
public class BCProcessShiftPCATest {
    ...
    class ComparisonTest {
        ...
        private static class Container {
            ...
            public void update(FAggregate aggregate) {
                double dShift = aggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_SHIFT));
                double dfPca = aggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_SHIFT_PCA));

                double dfError = 100 * ((dfPca - dShift) / dShift);

                this.dfShift.add(dShift);
