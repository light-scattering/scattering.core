...
public class BCProcessShiftTest {
    ...
    class VisualTest {
        ...
        void df14() {
            ...
            fAggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_BASELINE), meta);
            assertFalse(meta.getPythonRenderScript().isEmpty());

            fAggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_SHIFT), meta);
            assertFalse(meta.getPythonRenderScript().isEmpty());
        }
    ...
    class ComparisonTest {
        ...
        private static class Container {
            ...
            private final FStat dfBase = factory.getFStat();
            ...
            public void update(FAggregate aggregate) {
                double dfBase = aggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_BASELINE));
                double dfShift = aggregate.getFractalDimension(factory.getFConfigBC(FConfigBC.Preset.MAN_072026_SHIFT));

                double dfError = 100 * ((dfShift - dfBase) / dfBase);

                this.dfBase.add(dfBase);
            ...
            public void show() {
                System.out.println();
                System.out.printf("Dimension base:      %1.6f, %1.6f\n", dfBase.mean(), dfBase.std(true));
