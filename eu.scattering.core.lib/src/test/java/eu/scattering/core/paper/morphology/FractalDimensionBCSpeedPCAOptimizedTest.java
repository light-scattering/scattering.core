...
public class FractalDimensionBCSpeedPCAOptimizedTest {
    ...
    private static class Container {
        ...
        public void update(FAggregate aggregate) {
            ...
            double dfRaw = aggregate.getFractalDimension(FractalDimension.BC_SIMPLIFIED);
            long timeRawCheck = System.currentTimeMillis();

            aggregate.pca();

            long timeRefCheckB = System.currentTimeMillis();
            double dfPCA = aggregate.getFractalDimension(FractalDimension.BC_SIMPLIFIED);
            ...
            double dfError = 100 * ((dfRaw - dfPCA) / dfRaw);
