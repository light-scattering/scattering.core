...
public class FPos4DIDef implements FPos4DI {
    ...
    private FPos4DIDef(int d0, int d1, int d2, int d3) {
    ...
    public static FPos4DI create(int d0, int d1, int d2, int d3) {

        return new FPos4DIDef(d0, d1, d2, d3);
    }

    public static FPos4DI create(JSONObject json) {
...
//--------------------------------------------------
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof FPos4DIDef fPos4DI) {
