...
public class FRandDist3DNormalDef implements FRandDist3DNormal {
    ...
    private FRandDist3DNormalDef(TransferFactory factoryExt, FRandEngine random, double avg, double std) {
    ...
    public static FRandDist3DNormal create(TransferFactory factoryExt, FRandEngine random, double avg, double std) {

        return new FRandDist3DNormalDef(factoryExt, random, avg, std);
    }

    @Override
    public FRandDist3DNormal setAvg(double d0, double d1, double d2) {
    ...
    @Override
    public FRandDist3DNormal setStd(double d0, double d1, double d2) {
    ...
    @Override
    public FRandDist3DNormal setCorD01(double d01) {
    ...
    @Override
    public FRandDist3DNormal setCorD02(double d02) {
    ...
    @Override
    public FRandDist3DNormal setCorD12(double d12) {
