...
public class FModelPCFilippovDef implements FModelPCTunable {
    ...
    private void initParticleA() {
        Shape particleA = this.random.engine().getElement(this.detached, true);
    ...
    private void initParticleB() {
        ...
        Shape particleB = this.random.engine().getElement(this.detached, false);
    ...
    private void initParticleVariantDimension(Shape particleA, Shape particleB) {
        ...
        switch (this.dimension) {
            case D3 -> particleB.setCenter(this.random.engine().nextDoubleOnSphere(radius));
            case D2 -> particleB.setCenter(this.random.engine().nextDoubleOnCircle(radius), 0);
        }
    }
    ...
    private void positionVariantDimension(Shape particle, double radius) {
        ...
        switch (this.dimension) {
            case D3 -> particle.setCenter(this.random.engine().nextDoubleOnSphere(radius));
            case D2 -> particle.setCenter(this.random.engine().nextDoubleOnCircle(radius), 0);
        }
