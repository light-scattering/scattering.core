...
public class ComponentExporterDef implements ComponentExporter {

    private ComponentExporterDef() {}

    public static ComponentExporter create() {

       return new ComponentExporterDef();
    }
