...
import eu.scattering.core.impl.component.ComponentExporterDef;
import eu.scattering.core.impl.statistics.StatisticsExporterDef;
import eu.scattering.core.impl.storage.StorageExporterDef;

public class FExportAspectDef implements FExportAspect {
    private final StorageExporter storage;
    private final ComponentExporter component;
    private final StatisticsExporter statistics;

    private FExportAspectDef(ScatterFactory factory) {

        this.storage = StorageExporterDef.create();
        this.component = ComponentExporterDef.create();
        this.statistics = StatisticsExporterDef.create(factory);
    }

    public static FExportAspect create(ScatterFactory factory) {
