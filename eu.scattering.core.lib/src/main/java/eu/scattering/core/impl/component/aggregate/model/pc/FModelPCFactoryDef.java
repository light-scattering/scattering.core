...
public class FModelPCFactoryDef implements FModelPCFactory {
    private final ScatterFactory factory;

    private FModelPCFactoryDef(ScatterFactory factory) {

        this.factory = factory;
    }

    public static FModelPCFactory create(ScatterFactory factory) {

        return new FModelPCFactoryDef(factory);
    }
