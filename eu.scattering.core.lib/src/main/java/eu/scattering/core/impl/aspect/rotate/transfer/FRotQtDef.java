package eu.scattering.core.impl.aspect.rotate.transfer;
...
public class FRotQtDef implements FRotQt {
    ...
    private FRotQtDef(FPos4D qt, FPos3D offset, FMatrix3x3D matrix) {
    ...
    public static FRotQt create(FPos4D qt, FPos3D offset, FMatrix3x3D matrix) {
        ...
        return new FRotQtDef(qt, offset, matrix);
    }
