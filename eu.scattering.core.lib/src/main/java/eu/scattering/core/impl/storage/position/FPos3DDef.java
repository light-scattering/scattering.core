...
public class FPos3DDef implements FPos3D {
    ...
    private FPos3DDef(double d0, double d1, double d2) {
    ...
    public static FPos3D create(double d0, double d1, double d2) {

        return new FPos3DDef(d0, d1, d2);
    }

    public static FPos3D create(JSONObject json) {
...
//--------------------------------------------------
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof FPos3DDef fPos3D) {
