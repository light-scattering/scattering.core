...
public class FAggregateFactoryContextGeometriesDef implements FAggregateFactoryContextGeometries {
    private final ScatterFactory factory;

    private FAggregateFactoryContextGeometriesDef(ScatterFactory factory) {
    ...
    public static FAggregateFactoryContextGeometries create(ScatterFactory factory) {
        ...
        return new FAggregateFactoryContextGeometriesDef(factory);
    }
