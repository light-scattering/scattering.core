...
public class FRandEngineCoreSimpleDef implements FRandEngineCore {
    private final long seed;
    private final Random random;

    private FRandEngineCoreSimpleDef(long seed) {

        this.seed = seed;
        this.random = new Random(this.seed);
    }

    public static FRandEngineCore create(long seed) {

        return new FRandEngineCoreSimpleDef(seed);
    }
