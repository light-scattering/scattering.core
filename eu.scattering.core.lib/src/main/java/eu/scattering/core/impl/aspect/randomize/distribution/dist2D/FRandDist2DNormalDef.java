...
public class FRandDist2DNormalDef implements FRandDist2DNormal {
    ...
    private FRandDist2DNormalDef(TransferFactory factoryExt, FRandEngine random, double avg, double std) {
    ...
    public static FRandDist2DNormal create(TransferFactory factoryExt, FRandEngine random, double avg, double std) {

        return new FRandDist2DNormalDef(factoryExt, random, avg, std);
    }

    @Override
    public FRandDist2DNormal setAvg(double d0, double d1) {
    ...
    @Override
    public FRandDist2DNormal setStd(double d0, double d1) {
    ...
    @Override
    public FRandDist2DNormal setCor(double d01) {
