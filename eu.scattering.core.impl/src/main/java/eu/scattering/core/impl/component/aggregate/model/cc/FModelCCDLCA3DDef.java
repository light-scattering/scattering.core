...
public class FModelCCDLCA3DDef implements FModelCCDLCA {
    ...
    private FModelCCDLCA3DDef(FAggregate aggregate, ScatFactory factory) {
    ...
    public static FModelCCDLCA create(FAggregate aggregate, ScatFactory factory) {
        ...
        return new FModelCCDLCA3DDef(aggregate, factory);
    }
    ...
    private void buildFragments() {
        ...
        for (FAggregate fragment : this.fragments) {
            factory.getFModelContext().pc().dla(fragment).build();
        }
    }
