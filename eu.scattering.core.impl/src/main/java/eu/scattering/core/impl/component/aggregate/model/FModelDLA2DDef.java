...
public class FModelDLA2DDef implements FModelDLA {
    ...
    private FModelDLA2DDef(FAggregate aggregate, ScatFactory factory) {
    ...
    public static FModelDLA create(FAggregate aggregate, ScatFactory factory) {
        ...
        return new FModelDLA2DDef(aggregate, factory);
    }
    ...
    private boolean buildStep() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (this.dirHead.getZ() < 0 || this.dirHead.getZ() > 0) {
    ...
    private void setMovementDefault() {
        ...
        this.movement = (aggregate, particles, position) -> {
            FPos2D location = this.rndGen.nextDoubleOnCircle(this.step);

            position.add(location.getD0(), location.getD1(), 0);
        };
    }
