package eu.scattering.core.implementation.main.mutable.number.quaternion;
...
import eu.scattering.core.implementation.main.mutable.MutablePresetDevelopment;
...
public class FQuaternionDevelopment extends MutablePresetDevelopment<FQuaternion> implements FQuaternion {
    ...
    public double getDistance(FQuaternion element) {
        ...
        String name = "getDistance(FQuaternion)";
        long time = System.currentTimeMillis();
    ...
    public double getDistanceP2(FQuaternion element) {
        ...
        String name = "getDistanceP2(FQuaternion)";
        long time = System.currentTimeMillis();
