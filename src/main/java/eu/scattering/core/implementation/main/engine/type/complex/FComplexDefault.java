package eu.scattering.core.implementation.main.engine.type.complex;
...
public class FComplexDefault extends EnginePreset<FComplex> implements FComplex {
    ...
    public FComplex copy() {
        ...
        return EngineFactory.getFComplex().set(this);
    }
    ...
    public FComplex[] root(int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            res[i] = EngineFactory.getFComplex(valueRe, valueIm);
        }
