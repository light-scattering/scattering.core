package eu.scattering.core.main.engine.extension.line.impl;
...
public class FLine extends ExtensionPreset<IFLine> implements IFLine {
    ...
    public static IFLine create() {
        ...
        return new FLine().setOriginRef(MainFactory.getIFVector());
    }
    ...
    public Optional<IFPoint> getCommonIFPoint(IFLine ref) {
        ...
        IFVector w = MainFactory.getIFVector(v.getBase(), u.getBase());
