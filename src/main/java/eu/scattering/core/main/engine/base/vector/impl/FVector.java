package eu.scattering.core.main.engine.base.vector.impl;
...
import eu.scattering.core.main.engine.base.BasePreset;
...
public class FVector extends BasePreset<IFVector> implements IFVector {
...
//--------------------------------------------------
    ...
    public IFVector moveBase(IFPoint base) {
        IFPoint translation = MainFactory.getIFPoint().set(base).sub(getBase());
    ...
    public IFVector moveHead(IFPoint head) {
        IFPoint translation = MainFactory.getIFPoint().set(head).sub(getHead());
    ...
    public IFVector setOrthogonal(IFVector ref) throws PositionException, DirectionException {
        ...
        double magnitude = getLength();
        IFVector fVectorRef = MainFactory.getIFVector(ref.getBase().copy(), ref.getHead().copy());
