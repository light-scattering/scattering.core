package eu.scattering.core.impl.main.engine.base.vector;
...
import eu.scattering.core.impl.main.engine.base.BasePreset;
...
public class FVectorDefault extends BasePreset<FVector> implements FVector {
    ...
    public static FVectorDefault create() {
        ...
        fVector.origin[0] = MainFactory.getIFPoint();
        fVector.origin[1] = MainFactory.getIFPoint();
    ...
    public FVector importFromJSON(JSONObject json) {
        ...
        setBaseRef(MainFactory.getIFPoint().importFromJSON(structure.getJSONObject(0)));
        setHeadRef(MainFactory.getIFPoint().importFromJSON(structure.getJSONObject(1)));
    ...
    public FVectorDefault copy() {
        ...
        fVector.setBaseRef(MainFactory.getIFPoint(getBase()));
        fVector.setHeadRef(MainFactory.getIFPoint(getHead()));
...
//--------------------------------------------------
    ...
    public boolean isExact(double bX, double bY, double bZ, double hX, double hY, double hZ) {
        ...
        return isExact(MainFactory.getIFVector(bX, bY, bZ, hX, hY, hZ));
    }

    @Override
    public boolean isSimilar(double bX, double bY, double bZ, double hX, double hY, double hZ) {

        return isSimilar(MainFactory.getIFVector(bX, bY, bZ, hX, hY, hZ));
    }

    @Override
    public FVector moveBase() {

        return moveBase(MainFactory.getIFPoint());
    }

    @Override
    public FVector moveBase(double bX, double bY, double bZ) {

        return moveBase(MainFactory.getIFPoint(bX, bY, bZ));
    }

    @Override
    public FVector moveBase(FPoint base) {
        FPoint translation = MainFactory.getIFPoint().set(base).sub(getBase());
    ...
    public FVector moveHead() {
        ...
        return moveHead(MainFactory.getIFPoint());
    }

    @Override
    public FVector moveHead(double hX, double hY, double hZ) {

        return moveHead(MainFactory.getIFPoint(hX, hY, hZ));
    }

    @Override
    public FVector moveHead(FPoint head) {
        FPoint translation = MainFactory.getIFPoint().set(head).sub(getHead());
    ...
    @Override
    public FVector moveForward(double distance) throws DirectionException {
    ...
    @Override
    public FVector moveBackward(double distance) throws DirectionException {
    ...
    @Override
    public FVector normalize() throws DirectionException {
        FVector fCopyLocal = copy().moveBase();
    ...
    @Override
    public FVector setLength(double length) throws DirectionException {
        FVector fCopyLocal = copy().moveBase();
    ...
    @Override
    public double getAngle(FPoint ref) throws PositionException, DirectionException {

        if (getBase().isSimilar(ref)) {
            throw new PositionException("The provided IFPoint is at the same position as the base IFPoint");
        }

        return getAngle(MainFactory.getIFVector(getBase(), ref));
    }

    @Override
    public double getAngle(FVector ref) throws DirectionException {
    ...
    public double getDotProduct(FPoint ref) {
        ...
        return getDotProduct(MainFactory.getIFVector(getBase(), ref));
    }
    ...
    public FVector setCrossProduct(FPoint ref) {
        ...
        return setCrossProduct(MainFactory.getIFVector(getBase(), ref));
    }
    ...
    @Override
    public boolean isParallel(FVector ref) throws DirectionException {
    ...
    @Override
    public FVector setParallel(FVector ref) throws DirectionException {
    ...
    @Override
    public boolean isAntiParallel(FVector ref) throws DirectionException {
    ...
    @Override
    public FVector setAntiParallel(FVector ref) throws DirectionException {
    ...
    @Override
    public boolean isOrthogonal(FVector ref) throws DirectionException {
    ...
    @Override
    public FVector setOrthogonal(FVector ref) throws PositionException, DirectionException {
        ...
        double magnitude = getLength();
        FVector fVectorRef = MainFactory.getIFVector(ref.getBase().copy(), ref.getHead().copy());
