...
public class FVectorDev extends BasePreset<FVector> implements FVector {
    ...
    @Override
    public FVector ext(Consumer<BaseExtensionAssembly> exp) {
    ...
    @Override
    public FVector devDescribeStats() {
    ...
    @Override
    public FVector devDescribeClassStats() {
