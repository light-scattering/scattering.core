package eu.scattering.core.impl.main.engine.base.point;
...
public class FPointDev extends BasePreset<FPoint> implements FPoint {
    ...
    @Override
    public FPoint ext(Consumer<BaseExtensionAssembly> exp) {
    ...
    @Override
    public FPoint normalize() throws DirectionException {
    ...
    @Override
    public FPoint setLength(double length) throws DirectionException {
    ...
    @Override
    public double getAngle(FPoint ref) throws DirectionException {
    ...
    @Override
    public FPoint setDistance(FPoint ref, double distance) throws DirectionException {
    ...
    @Override
    public FPoint devDescribeStats() {
    ...
    @Override
    public FPoint devDescribeClassStats() {
