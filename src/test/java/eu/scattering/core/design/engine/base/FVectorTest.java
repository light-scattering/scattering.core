...
import eu.scattering.core.design.engine.base.helper.FVectorHelper;
...
public class FVectorTest {
    ...
    class FVectorBase {
        ...
        void constructWithParameters() {
            ...
            FVector fVector = EngineFactory.getFVector(valAX, valAY, valAZ, valBX, valBY, valBZ);
        ...
        void constructWithHeadParameters() {
            ...
            FVector fVector = EngineFactory.getFVector(valX, valY, valZ);
        ...
        void constructWithHead() {
            ...
            FVector fVector = EngineFactory.getFVector(fPointHead);
        ...
        void constructWithHeadAndParameters() {
            ...
            double valZ = RandomHelper.getTestValue();
            FPoint fPointHead = RandomHelper.getTestPoint();
            FVector fVector = EngineFactory.getFVector(valX, valY, valZ, fPointHead);
        ...
        void constructWithBaseAndParameters() {
            ...
            FVector fVector = EngineFactory.getFVector(fPointBase, valX, valY, valZ);
        ...
        void constructWithBaseHeadThrowIllegalArgumentException() {
            ...
            assertThrows(IllegalArgumentException.class, () -> EngineFactory.getFVector(fPoint, fPoint),
        ...
        void constructWithFVector() {
            FVector fVectorRef = EngineFactory.getFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = EngineFactory.getFVector(fVectorRef);
        ...
        void setBase() {
            ...
            fVector.setBase(EngineFactory.getFPoint());
        ...
        void setBaseRef() {
            ...
            fVector.setBaseRef(EngineFactory.getFPoint());
        ...
        void setHead() {
            ...
            fVector.setHead(EngineFactory.getFPoint());
        ...
        void setHeadRef() {
            ...
            fVector.setHeadRef(EngineFactory.getFPoint());
        ...
        void setBaseHead() {
            ...
            fVector.set(EngineFactory.getFPoint(), EngineFactory.getFPoint());
        ...
        void setBaseHeadRef() {
            ...
            fVector.setRef(EngineFactory.getFPoint(), EngineFactory.getFPoint());
    ...
    class FVectorAdvanced {
        ...
        void setSphericalCoordinates() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 1, 0);
            FPoint fPointHead = EngineFactory.getFPoint(2, 1, 0);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void setRandomAngle() {
            ...
            assertAll("Validate FPoint values",
                    () -> assertTrue(EngineFactory.getFPoint(1, 1, 0).isExact(fVector.getBase()),
                    "The base FPoint is erroneous"),
                    () -> assertFalse(EngineFactory.getFPoint(2, 1, 0).isExact(fVector.getHead()),
        ...
        void moveForwardSimple() {
            ...
            assertTrue(fVector.isSimilar(EngineFactory.getFVector(2, 2, 2, 3, 3, 3)),
                    "The FVector is erroneous");
        }
        ...
        void moveBackwardSimple() {
            ...
            assertTrue(fVector.isSimilar(EngineFactory.getFVector(0, 0, 0, 1, 1, 1)),
                    "The FVector is erroneous");
        }
        ...
        void addFVector() {
            FVector fVectorSum = EngineFactory.getFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = EngineFactory.getFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
        ...
        void subFVector() {
            FVector fVectorSub = EngineFactory.getFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = EngineFactory.getFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
        ...
        void getLength() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 1, 1);
            FPoint fPointHead = EngineFactory.getFPoint(2, 2, 2);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void getLengthZero() {
            FPoint fPointBase = EngineFactory.getFPoint();
            FPoint fPointHead = EngineFactory.getFPoint();
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void getLengthRandom() {
            FPoint fPointBase = EngineFactory.getFPoint(RandomHelper.getTestPoint());
            FPoint fPointHead = EngineFactory.getFPoint(RandomHelper.getTestPoint());
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void setLength() {
            FPoint fPointBase = EngineFactory.getFPoint(3, 3, 3);
            FPoint fPointHead = EngineFactory.getFPoint(5, 5, 5);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void setLengthOppositeDirection() {
            FVector fVector = EngineFactory.getFVector(1, 1, 1);

            fVector.setLength(-2 * Math.sqrt(3));

            assertTrue(EngineFactory.getFVector(-2, -2, -2).isSimilar(fVector), "" +
        ...
        void reflectHead() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 2, 3);
            FPoint fPointHead = RandomHelper.getTestPoint();
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void reflectBase() {
            FPoint fPointBase = RandomHelper.getTestPoint();
            FPoint fPointHead = EngineFactory.getFPoint(1, 2, 3);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void reflect() {
            ...
            FVector fVectorRef = EngineFactory.getFVector(fVector.getBase().copy().reflect(fPoint),
        ...
        void reflectSimple() {
            FVector fVector = EngineFactory.getFVector(1, 1, 0, 1, 3, 0);
            FPoint fPoint = EngineFactory.getFPoint(2, 2, 0);
        ...
        void invertDirection() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 2, 3);
            FPoint fPointHead = EngineFactory.getFPoint(4, 5, 6);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void getInclination() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 1, 0);
            FPoint fPointHead = EngineFactory.getFPoint(2, 2, 0);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void setInclination() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 1, 0);
            FPoint fPointHead = EngineFactory.getFPoint(1, 2, 0);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void getAzimuth() {
            FPoint fPointBase = EngineFactory.getFPoint(1, 1, 0);
            FPoint fPointHead = EngineFactory.getFPoint(2, 1, 1);
            FVector fVector = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void getAngle() {
            FPoint fPointBaseA = EngineFactory.getFPoint();
            FPoint fPointHeadA = EngineFactory.getFPoint(2, 2, 0);
            FVector fVectorA = EngineFactory.getFVector(fPointBaseA, fPointHeadA);

            FPoint fPointBaseB = EngineFactory.getFPoint();
            FPoint fPointHeadB = EngineFactory.getFPoint(4, -4, 0);
            FVector fVectorB = EngineFactory.getFVector(fPointBaseB, fPointHeadB);
        ...
        void getAngleParallel() {
            FVector fVectorA = EngineFactory.getFVector(EngineFactory.getFPoint(2, 2, 2));
            FVector fVectorB = EngineFactory.getFVector(EngineFactory.getFPoint(4, 4, 4));
        ...
        void getAngleOrthogonal() {
            FVector fVectorA = EngineFactory.getFVector(EngineFactory.getFPoint(0, 1, 0));
            FVector fVectorB = EngineFactory.getFVector(RandomHelper.getTestPoint().setY(0));
        ...
        void getAngleThrowIllegalStateExceptionInput() {
            FVector fVectorA = EngineFactory.getFVector();
        ...
        void getAngleThrowIllegalStateExceptionArgument() {
            FVector fVectorA = RandomHelper.getTestVector();
            FVector fVectorB = EngineFactory.getFVector();
        ...
        void getAngleWithFPoint() {
            FVector fVector = EngineFactory.getFVector(2, 2, 0);
            FPoint fPoint = EngineFactory.getFPoint(4, -4, 0);
        ...
        void getDotProduct() {
            ...
            fVectorA.moveBase(EngineFactory.getFPoint());
            fVectorB.moveBase(EngineFactory.getFPoint());
        ...
        void getDotProductSimple() {
            FVector fVectorA = EngineFactory.getFVector(0, 0, 0, 1, 2, 3);
            FVector fVectorB = EngineFactory.getFVector(0, 0, 0, 4, 5, 6);
        ...
        void setCrossProduct() {
            ...
            FVector fVectorRef = EngineFactory.getFVector(EngineFactory.getFPoint(dimX, dimY, dimZ));
        ...
        void setCrossProductSimple() {
            FVector fVectorA = EngineFactory.getFVector(0, 0, 0, 0, 0, 1);
            FVector fVectorB = EngineFactory.getFVector(0, 0, 0, 1, 0, 0);
            ...
            assertEquals(fVectorA, EngineFactory.getFVector(1, 1, 1, 1, 2, 1),
                    "The resulting FVector is erroneous");
        }
        ...
        void isParallelB() {
            FVector fVectorA = EngineFactory.getFVector(-1, 0, 0, 1, 0, 0);
            FVector fVectorB = EngineFactory.getFVector(-1, 1, 0, 1, 1, 0);
        ...
        void isParallelFail() {
            FVector fVectorA = EngineFactory.getFVector(RandomHelper.getTestPoint());
            FVector fVectorB = EngineFactory.getFVector(RandomHelper.getTestPoint(fVectorA.getHead()));
        ...
        void isParallelThrowIllegalStateExceptionInput() {
            FVector fVectorA = EngineFactory.getFVector(0, 0, 0);
            FVector fVectorB = RandomHelper.getTestVector();
        ...
        void isParallelThrowIllegalStateExceptionArgument() {
            FVector fVectorA = RandomHelper.getTestVector();
            FVector fVectorB = EngineFactory.getFVector(0, 0, 0);
        ...
        void isOrthogonal() {
            FVector fVectorA = EngineFactory.getFVector(0, 1, 0);
            FVector fVectorB = EngineFactory.getFVector(RandomHelper.getTestPoint().setY(0));
        ...
        void setOrthogonalSimple() {
            FVector fVectorA = EngineFactory.getFVector(-1, 0, 0);
            FVector fVectorB = EngineFactory.getFVector(0, 0, 1, 1, 0, 0);
        ...
        void setOrthogonalSameBase() {
            ...
            FVector fVectorB = EngineFactory.getFVector(fVectorA.getBase().copy(), fVectorBHead);
        ...
        void setOrthogonalSameHead() {
            ...
            FVector fVectorB = EngineFactory.getFVector(fVectorBBase, fVectorA.getHead().copy());
    ...
    class IFCoreFeatures {
        ...
        void parseJSON() {
            ...
            FVector fVector = EngineFactory.getFVector().importFromJSON(fVectorRef.exportToJSON());
        ...
        void isExact() {
            ...
            FVector fVectorA = EngineFactory.getFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = EngineFactory.getFVector(fPointBase, fPointHead);
        ...
        void isExactFail() {
            ...
            FVector fVectorA = EngineFactory.getFVector(EngineFactory.getFPoint(), fPointHead);
            FVector fVectorB = EngineFactory.getFVector(fPointBase, EngineFactory.getFPoint());
        ...
        void isExactWithParameters() {
            ...
            FVector fVector = EngineFactory.getFVector(bX, bY, bZ, hX, hY, hZ);
        ...
        void isSimilar() {
            ...
            FVector fVectorA = EngineFactory.getFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = EngineFactory.getFVector(fPointBase.addX(Config.getJitter() * 0.5), fPointHead);
        ...
        void isSimilarFail() {
            ...
            FVector fVectorA = EngineFactory.getFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = EngineFactory.getFVector(fPointBase.addX(Config.getJitter() * 1.5), fPointHead);
        ...
        void divFPointThrowArithmeticException() {
            ...
            assertAll("Division by zero",
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(EngineFactory.getFPoint(0, 1, 1)),
                            "The X value is zero"),
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(EngineFactory.getFPoint(1, 0, 1)),
                            "The Y value is zero"),
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(EngineFactory.getFPoint(0, 1, 1)),
                            "The Z value is zero")
