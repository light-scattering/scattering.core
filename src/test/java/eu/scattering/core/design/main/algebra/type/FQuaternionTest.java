...
public class FQuaternionTest {
    ...
    class BaseAlgebra {
        ...
        @BeforeEach
        void beforeEach() {
            refRe = random.getTestValue();
            refI = random.getTestValue();
            refJ = random.getTestValue();
            refK = random.getTestValue();

            opRe = random.getTestValue();
            opI = random.getTestValue();
            opJ = random.getTestValue();
            opK = random.getTestValue();
    ...
    class CoreFeatures {
        ...
        void parseJSON() {
            FQuaternion fQuaternionRef = factory.getFQuaternion(refRe, refI, refJ, refK);
            FQuaternion fQuaternionOp = factory.getFQuaternion().importFromJSON(fQuaternionRef.exportToJSON());
    ...
    class FQuaternionAdvanced {
        ...
        void getMagnitude() {
            FQuaternion fQuaternion = random.getTestQuaternion();
        ...
        void getDistance() {
            FQuaternion fQuaternionA = random.getTestQuaternion();
            FQuaternion fQuaternionB = random.getTestQuaternion(fQuaternionA);
        ...
        void setMagnitude() {
            FQuaternion fQuaternion = random.getTestQuaternion();
            double magnitude = Math.abs(random.getTestValue());
        ...
        void setMagnitudeThrowIllegalStateException() {
            ...
            assertThrows(IllegalStateException.class, () -> factory.getFQuaternion().setMagnitude(1),
        ...
        public void conjugate() {
            double re = random.getTestValue();
            double i = random.getTestValue();
            double j = random.getTestValue();
            double k = random.getTestValue();
            FQuaternion fComplex = factory.getFQuaternion(re, i, j, k);
        ...
        void normalizeThrowIllegalStateException() {
            ...
            assertThrows(IllegalStateException.class, () -> factory.getFQuaternion().normalize(),
                    "The direction is not defined");
        }
