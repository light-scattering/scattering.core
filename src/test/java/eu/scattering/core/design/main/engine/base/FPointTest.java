...
import eu.scattering.core.design.main.engine.base.helper.FPointHelper;
    ...
    class IFPointAdvanced {
        ...
        void getDistance() {
            ...
            assertEquals(reference, fPointA.getDistance(fPointB),
                    Config.getJitter(), "The distance between IFPoints is incorrect");
        }
        ...
        void setDistance() {
            ...
            assertEquals(distance, fPointA.getDistance(fPointB),
                    Config.getJitter(), "The distance between IFPoints is erroneous");
        }
