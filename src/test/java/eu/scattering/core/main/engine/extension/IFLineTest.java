...
import eu.scattering.core.main.engine.extension.helper.HelperIFLine;
...
public class IFLineTest {
    ...
    class IFLineBase {
        ...
        void constructWithIFVector() {
            ...
            IFLine fLine = MainFactory.getIFLine(fVector);
        ...
        void setOriginRef() {
            ...
            IFLine fLine = MainFactory.getIFLine(fVectorA);
        ...
        void getOriginValidatePositions() {
            IFVector fVector = HelperRandom.getTestVector();
            IFLine fLine = MainFactory.getIFLine(fVector.copy());
    ...
    class ICoreFeatures {
        ...
        void parseJSON() {
            IFVector fVector = HelperRandom.getTestVector();
            IFLine fLineA = MainFactory.getIFLine(fVector);
            IFLine fLineB = MainFactory.getIFLine().importFromJSON(fLineA.exportToJSON());
        ...
        void parseJSONExportValidate() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector());
        ...
        void isExact() {
            IFVector fVector = HelperRandom.getTestVector();
            IFLine fLineA = MainFactory.getIFLine(fVector.copy());
            IFLine fLineB = MainFactory.getIFLine(fVector.copy());
        ...
        void isExactFail() {
            IFVector fVector = HelperRandom.getTestVector();
            IFLine fLineA = MainFactory.getIFLine(fVector.copy());
            IFLine fLineB = MainFactory.getIFLine(fVector.copy().add(0.5 * jitter));
        ...
        void isExactValidate() {
            IFLine fLineA = MainFactory.getIFLine(MainFactory.getIFVector());
            IFLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector());
        ...
        void isSimilarFail() {
            IFLine fLineA = MainFactory.getIFLine(HelperRandom.getTestVector());
            IFLine fLineB = MainFactory.getIFLine(HelperRandom.getTestVector(fLineA.getOrigin()));
        ...
        void isSimilarValidate() {
            IFLine fLineA = MainFactory.getIFLine(HelperRandom.getTestVector());
            IFLine fLineB = MainFactory.getIFLine(HelperRandom.getTestVector());
        ...
        void getHashCodeFail() {
            IFVector fVector = HelperRandom.getTestVector();
            IFLine fLineA = MainFactory.getIFLine(fVector);
            IFLine fLineB = MainFactory.getIFLine(HelperRandom.getTestVector(fVector));
    ...
    class IFLineAdvanced {
        ...
        @DisplayName("Project")
        void project() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
        ...
        void projectPositionBase() {
            IFVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            IFLine fLine = MainFactory.getIFLine(fVector.copy());
            IFPoint fPoint = MainFactory.getIFPoint(0, -9, 0);
        ...
        void isPartOf() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
            IFPoint fPoint = MainFactory.getIFPoint(1, 1, 1).addY(0.5 * jitter);
        ...
        void isPartOfFail() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
            IFPoint fPoint = MainFactory.getIFPoint(1, 1, 1).addY(1.5 * jitter);
        ...
        void isPartOfPositionBase() {
            IFVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            IFLine fLine = MainFactory.getIFLine(fVector.copy());
            IFPoint fPoint = MainFactory.getIFPoint(-4, -4, -4).addY(0.5 * jitter);
        ...
        void moveForward() {
            IFVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            IFLine fLine = MainFactory.getIFLine(fVector.copy());
            IFPoint fPoint = MainFactory.getIFPoint(1, 0, 0);
        ...
        void getIFPointValidatePositions() {
            ...
            IFLine fLine = MainFactory.getIFLine(fVectorOrigin.copy());
        ...
        void getIFPointAtX() {
            ...
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(base.copy(), head.copy()));
        ...
        void getIFPointAtXEmpty() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(0, 1, 2));
        ...
        void getIFPointAtYEmpty() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(1, 0, 2));
        ...
        void getIFPointAtZEmpty() {
            IFLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(1, 2, 0));
        ...
        void getCommonIFPoint2DXY() {
            ...
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            ...
            IFVector fLineBOrigin = MainFactory.getIFVector(fLineBOriginBase, fLineBOriginHead);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint2DXYSimple() {
            IFVector fLineAOrigin = MainFactory.getIFVector(0, 0, 0, 1, 0, 0);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(1, -1, 0, 3, 1, 0);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint2DXYFail() {
            IFVector fLineAOrigin = MainFactory.getIFVector(1, 0, 0);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(-1, 1, 0, 1, 1, 0);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint() {
            ...
            IFPoint fLineBOriginBase = HelperRandom.getTestPoint();
            IFPoint fLineBOriginHead = fLineA.getIFPoint(HelperRandom.getTestValue());
            IFLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector(fLineBOriginBase, fLineBOriginHead));
        ...
        void getCommonIFPointStaticX() {
            IFVector fLineAOrigin = MainFactory.getIFVector(1, 1, 0, 1, 1, 1);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(1, 0, 0, 1, 3, 0);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointStaticY() {
            IFVector fLineAOrigin = MainFactory.getIFVector(1, 1, 0, 1, 1, 1);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(0, 1, 0, 3, 1, 0);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointStaticZ() {
            IFVector fLineAOrigin = MainFactory.getIFVector(0, 1, 1, 2, 1, 1);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(1, 0, 1, 1, 2, 1);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointFail() {
            ...
            IFPoint fLineBOriginHead = MainFactory.getIFPoint(HelperRandom.getTestPoint());

            while (fLineBOriginHead.extBoolean(fLineA.isPartOf()).get(0)) {
                fLineBOriginHead = MainFactory.getIFPoint(HelperRandom.getTestPoint());
            }
        ...
        void getCommonIFPointFailSimple() {
            IFVector fLineAOrigin = MainFactory.getIFVector(1, 0, 0);
            IFLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            IFVector fLineBOrigin = MainFactory.getIFVector(0, 1, 0, 0, 0, 1);
            IFLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointFailSameLine() {
            IFLine fLineA = MainFactory.getIFLine(MainFactory.getIFVector(1, 1, 1));
            IFLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector(-1, -1, -1));
