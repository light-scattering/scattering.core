...
import eu.scattering.core.main.engine.base.helper.HelperIFVector;
...
public class IFVectorTest {
    ...
    class IFVectorBase {
        ...
        void constructWithParameters() {
            ...
            IFVector fVector = MainFactory.getIFVector(valAX, valAY, valAZ, valBX, valBY, valBZ);
        ...
        void constructWithHeadParameters() {
            ...
            IFVector fVector = MainFactory.getIFVector(valX, valY, valZ);
        ...
        void constructWithHead() {
            ...
            IFVector fVector = MainFactory.getIFVector(fPointHead);
        ...
        void constructWithHeadAndParameters() {
            ...
            double valZ = HelperRandom.getTestValue();
            IFPoint fPointHead = HelperRandom.getTestPoint();
            IFVector fVector = MainFactory.getIFVector(valX, valY, valZ, fPointHead);
        ...
        void constructWithBaseAndParameters() {
            ...
            IFVector fVector = MainFactory.getIFVector(fPointBase, valX, valY, valZ);
        ...
        void constructWithIFVector() {
            IFVector fVectorRef = MainFactory.getIFVector(HelperRandom.getTestPoint(), HelperRandom.getTestPoint());
            IFVector fVector = MainFactory.getIFVector(fVectorRef);
    ...
    class IFVectorAdvanced {
        ...
        void setSphericalCoordinates() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            IFPoint fPointHead = MainFactory.getIFPoint(2, 1, 0);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void moveBaseValidate() {
            ...
            HelperIFVector.validateRef(IFVector::moveBase, fVector, fPoint);
        }
        ...
        void moveBaseWithParametersValidate() {
            ...
            HelperIFVector.validateRef(a -> a.moveBase(0, 0, 0), fVector);
        }
        ...
        void moveBaseToOXValidate() {
            ...
            HelperIFVector.validateRef(IFVector::moveBase, fVector);
        }
        ...
        void moveHeadValidate() {
            ...
            HelperIFVector.validateRef(IFVector::moveHead, fVector, fPoint);
        }
        ...
        void moveHeadWithParametersValidate() {
            ...
            HelperIFVector.validateRef(a -> a.moveHead(0, 0, 0), fVector);
        }
        ...
        void moveHeadToOXValidate() {
            ...
            HelperIFVector.validateRef(IFVector::moveHead, fVector);
        }
        ...
        void addIFVector() {
            IFVector fVectorSum = MainFactory.getIFVector(HelperRandom.getTestPoint(), HelperRandom.getTestPoint());
            IFVector fVector = MainFactory.getIFVector(HelperRandom.getTestPoint(), HelperRandom.getTestPoint());
        ...
        void subIFVector() {
            IFVector fVectorSub = MainFactory.getIFVector(HelperRandom.getTestPoint(), HelperRandom.getTestPoint());
            IFVector fVector = MainFactory.getIFVector(HelperRandom.getTestPoint(), HelperRandom.getTestPoint());
        ...
        void getLength() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 1, 1);
            IFPoint fPointHead = MainFactory.getIFPoint(2, 2, 2);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getLengthZero() {
            IFPoint fPointBase = MainFactory.getIFPoint();
            IFPoint fPointHead = MainFactory.getIFPoint();
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getLengthRandom() {
            IFPoint fPointBase = MainFactory.getIFPoint(HelperRandom.getTestPoint());
            IFPoint fPointHead = MainFactory.getIFPoint(HelperRandom.getTestPoint());
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setLength() {
            IFPoint fPointBase = MainFactory.getIFPoint(3, 3, 3);
            IFPoint fPointHead = MainFactory.getIFPoint(5, 5, 5);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setLengthOppositeDirection() {
            IFVector fVector = MainFactory.getIFVector(1, 1, 1);
        ...
        void reflectHead() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 2, 3);
            IFPoint fPointHead = HelperRandom.getTestPoint();
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void reflectBase() {
            IFPoint fPointBase = HelperRandom.getTestPoint();
            IFPoint fPointHead = MainFactory.getIFPoint(1, 2, 3);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void reflect() {
            ...
            IFVector fVectorRef = MainFactory.getIFVector(fVector.getBase().copy().reflect(fPoint),
        ...
        void reflectSimple() {
            IFVector fVector = MainFactory.getIFVector(1, 1, 0, 1, 3, 0);
            IFPoint fPoint = MainFactory.getIFPoint(2, 2, 0);
        ...
        void invertDirection() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 2, 3);
            IFPoint fPointHead = MainFactory.getIFPoint(4, 5, 6);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getInclination() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            IFPoint fPointHead = MainFactory.getIFPoint(2, 2, 0);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setInclination() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            IFPoint fPointHead = MainFactory.getIFPoint(1, 2, 0);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getAzimuth() {
            IFPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            IFPoint fPointHead = MainFactory.getIFPoint(2, 1, 1);
            IFVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getAngle() {
            IFPoint fPointBaseA = MainFactory.getIFPoint();
            IFPoint fPointHeadA = MainFactory.getIFPoint(2, 2, 0);
            IFVector fVectorA = MainFactory.getIFVector(fPointBaseA, fPointHeadA);

            IFPoint fPointBaseB = MainFactory.getIFPoint();
            IFPoint fPointHeadB = MainFactory.getIFPoint(4, -4, 0);
            IFVector fVectorB = MainFactory.getIFVector(fPointBaseB, fPointHeadB);

            fVectorA.moveBase(HelperRandom.getTestPoint());
            fVectorB.moveBase(HelperRandom.getTestPoint());
        ...
        void getAngleParallel() {
            IFVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(2, 2, 2));
            IFVector fVectorB = MainFactory.getIFVector(MainFactory.getIFPoint(4, 4, 4));
        ...
        void getAngleOrthogonal() {
            IFVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(0, 1, 0));
            IFVector fVectorB = MainFactory.getIFVector(HelperRandom.getTestPoint().setY(0));
        ...
        void getAngleThrowDirectionExceptionInput() {
            IFVector fVectorA = MainFactory.getIFVector();
        ...
        void getAngleThrowDirectionExceptionArgument() {
            IFVector fVectorA = HelperRandom.getTestVector();
            IFVector fVectorB = MainFactory.getIFVector();
        ...
        void getAngleWithIFPoint() {
            IFVector fVector = MainFactory.getIFVector(2, 2, 0);
            IFPoint fPoint = MainFactory.getIFPoint(4, -4, 0);
        ...
        void getAngleWithIFPointThrowPositionException() {
            IFVector fVector = HelperRandom.getTestVector();
            IFPoint fPoint = fVector.getBase().copy();
        ...
        void getDotProductSimple() {
            IFVector fVectorA = MainFactory.getIFVector(0, 0, 0, 1, 2, 3);
            IFVector fVectorB = MainFactory.getIFVector(0, 0, 0, 4, 5, 6);
        ...
        void setCrossProduct() {
            ...
            IFVector fVectorRes = fVectorA.copy().setCrossProduct(fVectorB);
            ...
            IFVector fVectorRef = MainFactory.getIFVector(MainFactory.getIFPoint(dimX, dimY, dimZ));
        ...
        void setCrossProductSimple() {
            IFVector fVectorA = MainFactory.getIFVector(0, 0, 0, 0, 0, 1);
            IFVector fVectorB = MainFactory.getIFVector(0, 0, 0, 1, 0, 0);
        ...
        void setCrossProductValidate() {
            ...
            HelperIFVector.validateRef(IFVector::setCrossProduct, fVectorA, fVectorB);
        }
        ...
        void setCrossProductWithIFPoint() {
            ...
            IFVector fVectorRes = fVector.copy().setCrossProduct(fPoint);
        ...
        void setCrossProductWithIFPointValidate() {
            ...
            HelperIFVector.validateRef(IFVector::setCrossProduct, fVector, fPoint);
        }
        ...
        void isParallelB() {
            IFVector fVectorA = MainFactory.getIFVector(-1, 0, 0, 1, 0, 0);
            IFVector fVectorB = MainFactory.getIFVector(-1, 1, 0, 1, 1, 0);
        ...
        void isParallelFail() {
            IFVector fVectorA = MainFactory.getIFVector(HelperRandom.getTestPoint());
            IFVector fVectorB = MainFactory.getIFVector(HelperRandom.getTestPoint(fVectorA.getHead()));
        ...
        void isParallelThrowDirectionExceptionInput() {
            IFVector fVectorA = MainFactory.getIFVector(0, 0, 0);
            IFVector fVectorB = HelperRandom.getTestVector();
        ...
        void isParallelThrowDirectionExceptionArgument() {
            IFVector fVectorA = HelperRandom.getTestVector();
            IFVector fVectorB = MainFactory.getIFVector(0, 0, 0);
        ...
        void isAntiParallelValidate() {
            ...
            HelperIFVector.validateVal(IFVector::isAntiParallel, fVectorA, fVectorB);
        }
        ...
        void setAntiParallelValidate() {
            ...
            HelperIFVector.validateRef(IFVector::setAntiParallel, fVectorA, fVectorB);
        }

        @Test
        @DisplayName("Is orthogonal")
        void isOrthogonal() {
            IFVector fVectorA = MainFactory.getIFVector(0, 1, 0);
            IFVector fVectorB = MainFactory.getIFVector(HelperRandom.getTestPoint().setY(0));
        ...
        void setOrthogonalSimple() {
            IFVector fVectorA = MainFactory.getIFVector(-1, 0, 0);
            IFVector fVectorB = MainFactory.getIFVector(0, 0, 1, 1, 0, 0);
        ...
        void setOrthogonalSameBase() {
            ...
            IFVector fVectorB = MainFactory.getIFVector(fVectorA.getBase().copy(), fVectorBHead);
        ...
        void setOrthogonalSameHead() {
            ...
            IFVector fVectorB = MainFactory.getIFVector(fVectorBBase, fVectorA.getHead().copy());
    ...
    class IFCoreFeatures {
        ...
        void parseJSON() {
            ...
            IFVector fVector = MainFactory.getIFVector().importFromJSON(fVectorRef.exportToJSON());
        ...
        void isExact() {
            ...
            IFVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            IFVector fVectorB = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void isExactFail() {
            ...
            IFVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(), fPointHead);
            IFVector fVectorB = MainFactory.getIFVector(fPointBase, MainFactory.getIFPoint());
        ...
        void isExactWithParameters() {
            ...
            IFVector fVector = MainFactory.getIFVector(bX, bY, bZ, hX, hY, hZ);
        ...
        void isSimilar() {
            ...
            IFVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            IFVector fVectorB = MainFactory.getIFVector(fPointBase.addX(jitter * 0.5), fPointHead);
        ...
        void isSimilarFail() {
            ...
            IFVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            IFVector fVectorB = MainFactory.getIFVector(fPointBase.addX(jitter * 1.5), fPointHead);
