...
public class DevTest {
    ...
    private static Dev<?> getTestInstance() {
    ...
    void beforeEach() {
        ...
        getTestInstance().devGetClassStats().ifPresent(Stats::reset);
    ...
    class DevIStats {
        ...
        class DevClass {
            ...
            void validateNumberOfInitiallyRegisteredEventsForClasses() {
                Optional<Stats> statsOpt = getTestInstance().devGetClassStats();
                Stats stats = statsOpt.orElseGet(() -> fail("Empty optional"));
        ...
        class DevObject {
            ...
            void registerSingleObjectEventEnabled() {
                ...
                Optional<Stats> statsOpt = getTestInstance().devGetStats();
                Stats stats = statsOpt.orElseGet(() -> fail("Empty optional"));
        ...
        class DevMethod {
            ...
            void getMethod() {
                ...
                Optional<StatsMethod> statsMethodOpt = stats.getMethod("test event 1");
            ...
            void getNonExistentMethod() {
                ...
                Optional<StatsMethod> statsMethodOpt = stats.getMethod("test event 2");
            ...
            void getExecutionTimes() {
                ...
                Optional<StatsMethod> statsMethodOpt = stats.getMethod("test event 1");
                StatsMethod statsMethod = statsMethodOpt.orElseGet(() -> fail("Empty optional"));
