...
import eu.scattering.core.logic.main.engine.base.helper.HelperFVector;
...
public class FVectorTest {
    ...
    class IFVectorBase {
        ...
        void constructWithParameters() {
            ...
            FVector fVector = MainFactory.getIFVector(valAX, valAY, valAZ, valBX, valBY, valBZ);
        ...
        void constructWithHeadParameters() {
            ...
            FVector fVector = MainFactory.getIFVector(valX, valY, valZ);
        ...
        void constructWithHead() {
            ...
            FVector fVector = MainFactory.getIFVector(fPointHead);
        ...
        void constructWithHeadAndParameters() {
            ...
            double valZ = RandomHelper.getTestValue();
            FPoint fPointHead = RandomHelper.getTestPoint();
            FVector fVector = MainFactory.getIFVector(valX, valY, valZ, fPointHead);
        ...
        void constructWithBaseAndParameters() {
            ...
            FVector fVector = MainFactory.getIFVector(fPointBase, valX, valY, valZ);
        ...
        void constructWithBaseHead() {
            FPoint fPointBase = RandomHelper.getTestPoint();
            FPoint fPointHead = RandomHelper.getTestPoint();
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void constructWithBaseHeadThrowIllegalArgumentException() {
            ...
            assertThrows(IllegalArgumentException.class, () -> MainFactory.getIFVector(fPoint, fPoint),
        ...
        void constructWithIFVector() {
            FVector fVectorRef = MainFactory.getIFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = MainFactory.getIFVector(fVectorRef);
        ...
        void setBase() {
            ...
            fVector.setBase(MainFactory.getIFPoint());
        ...
        void setBaseRef() {
            ...
            fVector.setBaseRef(MainFactory.getIFPoint());
        ...
        void setHead() {
            ...
            fVector.setHead(MainFactory.getIFPoint());
        ...
        void setHeadRef() {
            ...
            fVector.setHeadRef(MainFactory.getIFPoint());
        ...
        void setBaseHead() {
            ...
            fVector.set(MainFactory.getIFPoint(), MainFactory.getIFPoint());
        ...
        void setBaseHeadRef() {
            ...
            fVector.setRef(MainFactory.getIFPoint(), MainFactory.getIFPoint());
    ...
    class IFVectorAdvanced {
        ...
        void setSphericalCoordinates() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            FPoint fPointHead = MainFactory.getIFPoint(2, 1, 0);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setSphericalCoordinatesValidate() {
            ...
            HelperFVector.validateRef(e -> e.setSphericalCoordinates(0, 0), fVector);
        }
        ...
        void setRandomAngle() {
            ...
            assertAll("Validate IFPoint values",
                    () -> assertTrue(MainFactory.getIFPoint(1, 1, 0).isExact(fVector.getBase()),
                    "The base IFPoint is erroneous"),
                    () -> assertFalse(MainFactory.getIFPoint(2, 1, 0).isExact(fVector.getHead()),
        ...
        void setRandomAngleValidate() {
            ...
            HelperFVector.validateRef(e -> e.setRandomAngle(), fVector);
        }
        ...
        void moveBaseValidate() {
            ...
            HelperFVector.validateRef(FVector::moveBase, fVector, fPoint);
        }
        ...
        void moveBaseWithParametersValidate() {
            ...
            HelperFVector.validateRef(a -> a.moveBase(0, 0, 0), fVector);
        }
        ...
        void moveBaseToOXValidate() {
            ...
            HelperFVector.validateRef(FVector::moveBase, fVector);
        }
        ...
        void moveHeadValidate() {
            ...
            HelperFVector.validateRef(FVector::moveHead, fVector, fPoint);
        }
        ...
        void moveHeadWithParametersValidate() {
            ...
            HelperFVector.validateRef(a -> a.moveHead(0, 0, 0), fVector);
        }
        ...
        void moveHeadToOXValidate() {
            ...
            HelperFVector.validateRef(FVector::moveHead, fVector);
        }
        ...
        void moveForwardSimple() {
            FVector fVector = MainFactory.getIFVector(1, 1, 1, 2, 2, 2);

            fVector.moveForward(Math.sqrt(3));

            assertTrue(fVector.isSimilar(MainFactory.getIFVector(2, 2, 2, 3, 3, 3)),
                    "The IFVector is erroneous");
        }
        ...
        void moveForwardValidate() {
            ...
            HelperFVector.validateRef(a -> a.moveForward(1), fVector);
        }
        ...
        void moveBackwardSimple() {
            ...
            assertTrue(fVector.isSimilar(MainFactory.getIFVector(0, 0, 0, 1, 1, 1)),
                    "The IFVector is erroneous");
        }
        ...
        void moveBackwardValidate() {
            ...
            HelperFVector.validateRef(a -> a.moveBackward(1), fVector);
        }

        @Test
        @DisplayName("Add IFVector")
        void addIFVector() {
            FVector fVectorSum = MainFactory.getIFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = MainFactory.getIFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
        ...
        void addIFVectorValidate() {
            ...
            HelperFVector.validateRef(FVector::add, fVectorA, fVectorB);
        }

        @Test
        @DisplayName("Sub IFVector")
        void subIFVector() {
            FVector fVectorSub = MainFactory.getIFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
            FVector fVector = MainFactory.getIFVector(RandomHelper.getTestPoint(), RandomHelper.getTestPoint());
        ...
        void subIFVectorValidate() {
            ...
            HelperFVector.validateRef(FVector::sub, fVectorA, fVectorB);
        }
        ...
        void getLengthXValidate() {
            ...
            HelperFVector.validateVal(FVector::getLengthX, fVector);
        }
        ...
        void getLengthYValidate() {
            ...
            HelperFVector.validateVal(FVector::getLengthY, fVector);
        }
        ...
        void getLengthZValidate() {
            ...
            HelperFVector.validateVal(FVector::getLengthZ, fVector);
        }

        @Test
        @DisplayName("Get length")
        void getLength() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 1, 1);
            FPoint fPointHead = MainFactory.getIFPoint(2, 2, 2);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getLengthZero() {
            FPoint fPointBase = MainFactory.getIFPoint();
            FPoint fPointHead = MainFactory.getIFPoint();
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getLengthRandom() {
            FPoint fPointBase = MainFactory.getIFPoint(RandomHelper.getTestPoint());
            FPoint fPointHead = MainFactory.getIFPoint(RandomHelper.getTestPoint());
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getLengthValidate() {
            ...
            HelperFVector.validateVal(FVector::getLength, fVector);
        }

        @Test
        @DisplayName("Set length")
        void setLength() {
            FPoint fPointBase = MainFactory.getIFPoint(3, 3, 3);
            FPoint fPointHead = MainFactory.getIFPoint(5, 5, 5);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setLengthOppositeDirection() {
            FVector fVector = MainFactory.getIFVector(1, 1, 1);

            fVector.setLength(-2 * Math.sqrt(3));

            assertTrue(MainFactory.getIFVector(-2, -2, -2).isSimilar(fVector), "" +
        ...
        void setLengthValidate() {
            ...
            HelperFVector.validateRef(a -> a.setLength(1), fVector);
        }
        ...
        void normalizeValidate() {
            ...
            HelperFVector.validateRef(FVector::normalize, fVector);
        }

        @Test
        @DisplayName("Reflect head")
        void reflectHead() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 2, 3);
            FPoint fPointHead = RandomHelper.getTestPoint();
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void reflectHeadValidate() {
            ...
            HelperFVector.validateRef(FVector::reflectHead, fVector);
        }
        ...
        void reflectBase() {
            FPoint fPointBase = RandomHelper.getTestPoint();
            FPoint fPointHead = MainFactory.getIFPoint(1, 2, 3);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void reflectBaseValidate() {
            ...
            HelperFVector.validateRef(FVector::reflectBase, fVector);
        }
        ...
        void reflect() {
            ...
            FVector fVectorRef = MainFactory.getIFVector(fVector.getBase().copy().reflect(fPoint),
        ...
        void reflectSimple() {
            FVector fVector = MainFactory.getIFVector(1, 1, 0, 1, 3, 0);
            FPoint fPoint = MainFactory.getIFPoint(2, 2, 0);
        ...
        void reflectValidate() {
            ...
            HelperFVector.validateRef(FVector::reflect, fVector, fPoint);
        }
        ...
        void invertDirection() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 2, 3);
            FPoint fPointHead = MainFactory.getIFPoint(4, 5, 6);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getInclination() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            FPoint fPointHead = MainFactory.getIFPoint(2, 2, 0);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getInclinationValidate() {
            ...
            HelperFVector.validateVal(FVector::getInclination, fVector);
        }
        ...
        void setInclination() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            FPoint fPointHead = MainFactory.getIFPoint(1, 2, 0);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void setInclinationValidate() {
            ...
            HelperFVector.validateRef(a -> a.setInclination(Math.PI * 0.5), fVector);
        }
        ...
        void getAzimuth() {
            FPoint fPointBase = MainFactory.getIFPoint(1, 1, 0);
            FPoint fPointHead = MainFactory.getIFPoint(2, 1, 1);
            FVector fVector = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void getAzimuthValidate() {
            ...
            HelperFVector.validateVal(FVector::getAzimuth, fVector);
        }
        ...
        void setAzimuthValidate() {
            ...
            HelperFVector.validateRef(a -> a.setAzimuth(Math.PI * 0.5), fVector);
        }

        @Test
        @DisplayName("Get angle")
        void getAngle() {
            FPoint fPointBaseA = MainFactory.getIFPoint();
            FPoint fPointHeadA = MainFactory.getIFPoint(2, 2, 0);
            FVector fVectorA = MainFactory.getIFVector(fPointBaseA, fPointHeadA);

            FPoint fPointBaseB = MainFactory.getIFPoint();
            FPoint fPointHeadB = MainFactory.getIFPoint(4, -4, 0);
            FVector fVectorB = MainFactory.getIFVector(fPointBaseB, fPointHeadB);
        ...
        void getAngleParallel() {
            FVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(2, 2, 2));
            FVector fVectorB = MainFactory.getIFVector(MainFactory.getIFPoint(4, 4, 4));
        ...
        void getAngleOrthogonal() {
            FVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(0, 1, 0));
            FVector fVectorB = MainFactory.getIFVector(RandomHelper.getTestPoint().setY(0));
        ...
        void getAngleThrowDirectionExceptionInput() {
            FVector fVectorA = MainFactory.getIFVector();
        ...
        void getAngleThrowDirectionExceptionArgument() {
            FVector fVectorA = RandomHelper.getTestVector();
            FVector fVectorB = MainFactory.getIFVector();
        ...
        void getAngleValidate() {
            ...
            HelperFVector.validateVal(FVector::getAngle, fVectorA, fVectorB);
        }

        @Test
        @DisplayName("Get angle with IFPoint")
        void getAngleWithIFPoint() {
            FVector fVector = MainFactory.getIFVector(2, 2, 0);
            FPoint fPoint = MainFactory.getIFPoint(4, -4, 0);
        ...
        void getAngleWithIFPointValidate() {
            ...
            HelperFVector.validateVal(FVector::getAngle, fVector, fPoint);
        }
        ...
        void getDotProduct() {
            ...
            fVectorA.moveBase(MainFactory.getIFPoint());
            fVectorB.moveBase(MainFactory.getIFPoint());
        ...
        void getDotProductSimple() {
            FVector fVectorA = MainFactory.getIFVector(0, 0, 0, 1, 2, 3);
            FVector fVectorB = MainFactory.getIFVector(0, 0, 0, 4, 5, 6);
        ...
        void getDotProductValidate() {
            ...
            HelperFVector.validateVal(FVector::getDotProduct, fVectorA, fVectorB);
        }
        ...
        void getDotProductWithIFPointValidate() {
            ...
            HelperFVector.validateVal(FVector::getDotProduct, fVector, fPoint);
        }
        ...
        void setCrossProduct() {
            ...
            FVector fVectorRef = MainFactory.getIFVector(MainFactory.getIFPoint(dimX, dimY, dimZ));
        ...
        void setCrossProductSimple() {
            FVector fVectorA = MainFactory.getIFVector(0, 0, 0, 0, 0, 1);
            FVector fVectorB = MainFactory.getIFVector(0, 0, 0, 1, 0, 0);
            ...
            assertEquals(fVectorA, MainFactory.getIFVector(1, 1, 1, 1, 2, 1),
                    "The resulting IFVector is erroneous");
        }
        ...
        void setCrossProductValidate() {
            ...
            HelperFVector.validateRef(FVector::setCrossProduct, fVectorA, fVectorB);
        }
        ...
        void setCrossProductWithIFPointValidate() {
            ...
            HelperFVector.validateRef(FVector::setCrossProduct, fVector, fPoint);
        }
        ...
        void isParallelB() {
            FVector fVectorA = MainFactory.getIFVector(-1, 0, 0, 1, 0, 0);
            FVector fVectorB = MainFactory.getIFVector(-1, 1, 0, 1, 1, 0);
        ...
        void isParallelFail() {
            FVector fVectorA = MainFactory.getIFVector(RandomHelper.getTestPoint());
            FVector fVectorB = MainFactory.getIFVector(RandomHelper.getTestPoint(fVectorA.getHead()));
        ...
        void isParallelThrowDirectionExceptionInput() {
            FVector fVectorA = MainFactory.getIFVector(0, 0, 0);
            FVector fVectorB = RandomHelper.getTestVector();
        ...
        void isParallelThrowDirectionExceptionArgument() {
            FVector fVectorA = RandomHelper.getTestVector();
            FVector fVectorB = MainFactory.getIFVector(0, 0, 0);
        ...
        void isParallelValidate() {
            ...
            HelperFVector.validateVal(FVector::isParallel, fVectorA, fVectorB);
        }
        ...
        void setParallelValidate() {
            ...
            HelperFVector.validateRef(FVector::setParallel, fVectorA, fVectorB);
        }
        ...
        void isAntiParallelValidate() {
            ...
            HelperFVector.validateVal(FVector::isAntiParallel, fVectorA, fVectorB);
        }
        ...
        void setAntiParallelValidate() {
            ...
            HelperFVector.validateRef(FVector::setAntiParallel, fVectorA, fVectorB);
        }

        @Test
        @DisplayName("Is orthogonal")
        void isOrthogonal() {
            FVector fVectorA = MainFactory.getIFVector(0, 1, 0);
            FVector fVectorB = MainFactory.getIFVector(RandomHelper.getTestPoint().setY(0));
        ...
        void isOrthogonalValidate() {
            ...
            HelperFVector.validateVal(FVector::isOrthogonal, fVectorA, fVectorB);
        }
        ...
        void setOrthogonalSimple() {
            FVector fVectorA = MainFactory.getIFVector(-1, 0, 0);
            FVector fVectorB = MainFactory.getIFVector(0, 0, 1, 1, 0, 0);
        ...
        void setOrthogonalSameBase() {
            ...
            FVector fVectorB = MainFactory.getIFVector(fVectorA.getBase().copy(), fVectorBHead);
        ...
        void setOrthogonalSameHead() {
            ...
            FVector fVectorB = MainFactory.getIFVector(fVectorBBase, fVectorA.getHead().copy());
        ...
        void setOrthogonalValidate() {
            ...
            HelperFVector.validateRef(FVector::setOrthogonal, fVectorA, fVectorB);
        }
        ...
        void isNonDirectionalValidate() {
            ...
            HelperFVector.validateVal(FVector::isNonDirectional, fVector);
        }
    ...
    class IFCoreFeatures {
        ...
        void parseJSON() {
            ...
            FVector fVector = MainFactory.getIFVector().importFromJSON(fVectorRef.exportToJSON());
        ...
        void parseJSONExportValidate() {
            ...
            HelperFVector.validateVal(FVector::exportToJSON, fVector);
        }
        ...
        void isExact() {
            ...
            FVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = MainFactory.getIFVector(fPointBase, fPointHead);
        ...
        void isExactFail() {
            ...
            FVector fVectorA = MainFactory.getIFVector(MainFactory.getIFPoint(), fPointHead);
            FVector fVectorB = MainFactory.getIFVector(fPointBase, MainFactory.getIFPoint());
        ...
        void isExactValidate() {
            ...
            HelperFVector.validateVal(FVector::isExact, fVectorA, fVectorB);
        }
        ...
        void isExactWithParameters() {
            ...
            FVector fVector = MainFactory.getIFVector(bX, bY, bZ, hX, hY, hZ);
        ...
        void isExactWithParametersValidate() {
            ...
            HelperFVector.validateVal(e -> e.isExact(0, 0, 0, 0, 0, 0), fVector);
        }
        ...
        void isSimilar() {
            ...
            FVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = MainFactory.getIFVector(fPointBase.addX(jitter * 0.5), fPointHead);
        ...
        void isSimilarFail() {
            ...
            FVector fVectorA = MainFactory.getIFVector(fPointBase.copy(), fPointHead.copy());
            FVector fVectorB = MainFactory.getIFVector(fPointBase.addX(jitter * 1.5), fPointHead);
        ...
        void isSimilarValidate() {
            ...
            HelperFVector.validateVal(FVector::isSimilar, fVectorA, fVectorB);
        }
        ...
        void isSimilarWithParametersValidate() {
            ...
            HelperFVector.validateVal(e -> e.isSimilar(0, 0, 0, 0, 0, 0), fVector);
        }
        ...
        void getHashCodeValidate() {
            ...
            HelperFVector.validateVal(FVector::hashCode, fVector);
        }
        ...
        void copyValidate() {
            ...
            HelperFVector.validateVal(FVector::copy, fVector);
        }
    ...
    class IBaseAlgebra {
        ...
        void addPrimitivesValidate() {
            ...
            HelperFVector.validateVal(e -> e.add(0, 0, 0), fVector);
        }
        ...
        void addFactorValidate() {
            ...
            HelperFVector.validateVal(e -> e.add(0), fVector);
        }
        ...
        void addXValidate() {
            ...
            HelperFVector.validateVal(e -> e.addX(0), fVector);
        }
        ...
        void addYValidate() {
            ...
            HelperFVector.validateVal(e -> e.addY(0), fVector);
        }
        ...
        void addZValidate() {
            ...
            HelperFVector.validateVal(e -> e.addZ(0), fVector);
        }
        ...
        void subPrimitivesValidate() {
            ...
            HelperFVector.validateVal(e -> e.sub(0, 0, 0), fVector);
        }
        ...
        void subFactorValidate() {
            ...
            HelperFVector.validateVal(e -> e.sub(0), fVector);
        }
        ...
        void subXValidate() {
            ...
            HelperFVector.validateVal(e -> e.subX(0), fVector);
        }
        ...
        void subYValidate() {
            ...
            HelperFVector.validateVal(e -> e.subY(0), fVector);
        }
        ...
        void subZValidate() {
            ...
            HelperFVector.validateVal(e -> e.subZ(0), fVector);
        }
        ...
        void mulIFPointValidate() {
            ...
            HelperFVector.validateRef(FVector::mul, fVector, fPoint);
        }
        ...
        void mulPrimitivesValidate() {
            ...
            HelperFVector.validateVal(e -> e.mul(1, 1, 1), fVector);
        }
        ...
        void mulFactorValidate() {
            ...
            HelperFVector.validateVal(e -> e.mul(1), fVector);
        }
        ...
        void mulXValidate() {
            ...
            HelperFVector.validateVal(e -> e.mulX(1), fVector);
        }
        ...
        void mulYValidate() {
            ...
            HelperFVector.validateVal(e -> e.mulY(1), fVector);
        }
        ...
        void mulZValidate() {
            ...
            HelperFVector.validateVal(e -> e.mulZ(1), fVector);
        }
        ...
        void divIFPointThrowArithmeticException() {
            ...
            assertAll("Division by zero",
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(MainFactory.getIFPoint(0, 1, 1)),
                            "The X value is zero"),
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(MainFactory.getIFPoint(1, 0, 1)),
                            "The Y value is zero"),
                    () -> assertThrows(ArithmeticException.class,
                            () -> fVector.div(MainFactory.getIFPoint(0, 1, 1)),
                            "The Z value is zero")
        ...
        void divIFPointValidate() {
            ...
            HelperFVector.validateRef(FVector::div, fVector, fPoint);
        }
        ...
        void divPrimitivesValidate() {
            ...
            HelperFVector.validateVal(e -> e.div(1, 1, 1), fVector);
        }
        ...
        void divFactorValidate() {
            ...
            HelperFVector.validateVal(e -> e.div(1), fVector);
        }
        ...
        void divXValidate() {
            ...
            HelperFVector.validateVal(e -> e.divX(1), fVector);
        }
        ...
        void divYValidate() {
            ...
            HelperFVector.validateVal(e -> e.divY(1), fVector);
        }
        ...
        void divZValidate() {
            ...
            HelperFVector.validateVal(e -> e.divZ(1), fVector);
        }
        ...
        void getIFPointsValidate() {
            ...
            HelperFVector.validateVal(FVector::disassemble, fVector);
        }
