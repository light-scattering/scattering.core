...
import eu.scattering.core.logic.main.engine.extension.helper.FLineHelper;
...
public class FLineTest {
    ...
    class IFLineBase {
        ...
        void construct() {
            FLine fLine = MainFactory.getIFLine();
        ...
        void constructValidatePositions() {
            ...
            assertEquals(MainFactory.getIFVector(), fLine.getOrigin(),
        ...
        void constructWithIFVector() {
            ...
            FLine fLine = MainFactory.getIFLine(fVector);
        ...
        void constructWithIFVectorValidatePositions() {
            ...
            FPoint fPointBase = MainFactory.getIFPoint(refAX, refAY, refAZ);
            FPoint fPointHead = MainFactory.getIFPoint(refBX, refBY, refBZ);
        ...
        void setOriginRef() {
            ...
            FLine fLine = MainFactory.getIFLine(fVectorA);
        ...
        void getOriginValidatePositions() {
            FVector fVector = RandomHelper.getTestVector();
            FLine fLine = MainFactory.getIFLine(fVector.copy());
    ...
    class ICoreFeatures {
        ...
        void parseJSON() {
            FVector fVector = RandomHelper.getTestVector();
            FLine fLineA = MainFactory.getIFLine(fVector);
            FLine fLineB = MainFactory.getIFLine().importFromJSON(fLineA.exportToJSON());
        ...
        void parseJSONExportValidate() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector());
        ...
        void isExact() {
            FVector fVector = RandomHelper.getTestVector();
            FLine fLineA = MainFactory.getIFLine(fVector.copy());
            FLine fLineB = MainFactory.getIFLine(fVector.copy());
        ...
        void isExactFail() {
            FVector fVector = RandomHelper.getTestVector();
            FLine fLineA = MainFactory.getIFLine(fVector.copy());
            FLine fLineB = MainFactory.getIFLine(fVector.copy().add(0.5 * jitter));
        ...
        void isExactValidate() {
            FLine fLineA = MainFactory.getIFLine(MainFactory.getIFVector());
            FLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector());
        ...
        void isSimilarFail() {
            FLine fLineA = MainFactory.getIFLine(RandomHelper.getTestVector());
            FLine fLineB = MainFactory.getIFLine(RandomHelper.getTestVector(fLineA.getOrigin()));
        ...
        void isSimilarValidate() {
            FLine fLineA = MainFactory.getIFLine(RandomHelper.getTestVector());
            FLine fLineB = MainFactory.getIFLine(RandomHelper.getTestVector());
        ...
        void getHashCodeFail() {
            FVector fVector = RandomHelper.getTestVector();
            FLine fLineA = MainFactory.getIFLine(fVector);
            FLine fLineB = MainFactory.getIFLine(RandomHelper.getTestVector(fVector));
    ...
    class IFLineAdvanced {
        ...
        @DisplayName("Project")
        void project() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
            FPoint fPoint = MainFactory.getIFPoint(0, 3, 0);
            ...
            assertTrue(MainFactory.getIFPoint(1, 1, 1).add(relocation).isSimilar(fPoint),
        ...
        void projectPositionBase() {
            FVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            FLine fLine = MainFactory.getIFLine(fVector.copy());
            FPoint fPoint = MainFactory.getIFPoint(0, -9, 0);
        ...
        void isPartOf() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
            FPoint fPoint = MainFactory.getIFPoint(1, 1, 1).addY(0.5 * jitter);
        ...
        void isPartOfFail() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(2, 2, 2));
            FPoint fPoint = MainFactory.getIFPoint(1, 1, 1).addY(1.5 * jitter);
        ...
        void isPartOfPositionBase() {
            FVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            FLine fLine = MainFactory.getIFLine(fVector.copy());
            FPoint fPoint = MainFactory.getIFPoint(-4, -4, -4).addY(0.5 * jitter);
        ...
        void moveForward() {
            FVector fVector = MainFactory.getIFVector(4, 4, 4).sub(2);
            FLine fLine = MainFactory.getIFLine(fVector.copy());
            FPoint fPoint = MainFactory.getIFPoint(1, 0, 0);

            fPoint.ext(fLine.moveForward(Math.sqrt(3)));

            assertTrue(fPoint.isSimilar(MainFactory.getIFPoint(2, 1, 1)),
        ...
        void moveForwardNegative() {
            ...
            assertTrue(fPoint.isSimilar(MainFactory.getIFPoint(0, -1, -1)),
                    "The translation is erroneous");
        }
        ...
        void getIFPoint() {
            FLine fLine = MainFactory.getIFLine(RandomHelper.getTestVector());
        ...
        void getIFPointValidatePositions() {
            ...
            FLine fLine = MainFactory.getIFLine(fVectorOrigin.copy());
        ...
        void getIFPointAtX() {
            ...
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(base.copy(), head.copy()));
        ...
        void getIFPointAtXEmpty() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(0, 1, 2));
        ...
        void getIFPointAtYEmpty() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(1, 0, 2));
        ...
        void getIFPointAtZEmpty() {
            FLine fLine = MainFactory.getIFLine(MainFactory.getIFVector(1, 2, 0));
        ...
        void getCommonIFPoint2DXY() {
            ...
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            ...
            FVector fLineBOrigin = MainFactory.getIFVector(fLineBOriginBase, fLineBOriginHead);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint2DXYSimple() {
            FVector fLineAOrigin = MainFactory.getIFVector(0, 0, 0, 1, 0, 0);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(1, -1, 0, 3, 1, 0);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint2DXYFail() {
            FVector fLineAOrigin = MainFactory.getIFVector(1, 0, 0);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(-1, 1, 0, 1, 1, 0);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPoint() {
            ...
            FPoint fLineBOriginBase = RandomHelper.getTestPoint();
            FPoint fLineBOriginHead = fLineA.getIFPoint(RandomHelper.getTestValue());
            FLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector(fLineBOriginBase, fLineBOriginHead));
        ...
        void getCommonIFPointStaticX() {
            FVector fLineAOrigin = MainFactory.getIFVector(1, 1, 0, 1, 1, 1);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(1, 0, 0, 1, 3, 0);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
            ...
            assertAll("Validate IFPoint",
                    () -> assertEquals(fPointRes.get(), MainFactory.getIFPoint(1, 1, 0),
        ...
        void getCommonIFPointStaticY() {
            FVector fLineAOrigin = MainFactory.getIFVector(1, 1, 0, 1, 1, 1);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(0, 1, 0, 3, 1, 0);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointStaticZ() {
            FVector fLineAOrigin = MainFactory.getIFVector(0, 1, 1, 2, 1, 1);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(1, 0, 1, 1, 2, 1);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
            ...
            assertAll("Validate IFPoint",
                    () -> assertEquals(fPointRes.get(), MainFactory.getIFPoint(1, 1, 1),
                            "The IFPoint is erroneous"),
                    () -> assertTrue(fPointRes.get().extBoolean(fLineA.isPartOf()).get(0),
                            "The IFPoint should be part of IFLine 1 " +
                                    "(distance: " + fPointRes.get().extDouble(fLineA.getDistance()).get(0)+ ")"),
        ...
        void getCommonIFPointFail() {
            ...
            FPoint fLineBOriginHead = MainFactory.getIFPoint(RandomHelper.getTestPoint());

            while (fLineBOriginHead.extBoolean(fLineA.isPartOf()).get(0)) {
                fLineBOriginHead = MainFactory.getIFPoint(RandomHelper.getTestPoint());
            }
            ...
            FVector fVectorDrift = fLineA.getOrigin().copy().setCrossProduct(fLineBOrigin).setLength(1.5 * jitter);
        ...
        void getCommonIFPointFailSimple() {
            FVector fLineAOrigin = MainFactory.getIFVector(1, 0, 0);
            FLine fLineA = MainFactory.getIFLine(fLineAOrigin);
            FVector fLineBOrigin = MainFactory.getIFVector(0, 1, 0, 0, 0, 1);
            FLine fLineB = MainFactory.getIFLine(fLineBOrigin);
        ...
        void getCommonIFPointFailSameLine() {
            FLine fLineA = MainFactory.getIFLine(MainFactory.getIFVector(1, 1, 1));
            FLine fLineB = MainFactory.getIFLine(MainFactory.getIFVector(-1, -1, -1));
        ...
        void getCommonIFPointValidate() {
            ...
            FLineHelper.validateVal((a, b) -> a.getCommonIFPoint(b), fLineA, fLineB);
        }
