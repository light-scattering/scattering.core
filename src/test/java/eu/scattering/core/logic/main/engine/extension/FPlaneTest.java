...
import eu.scattering.core.logic.main.engine.extension.helper.FPlaneHelper;
...
public class FPlaneTest {
    ...
    class IFPlaneBase {
        ...
        void construct() {
            FPlane fPlane = MainFactory.getIFPlane();
        ...
        void constructWithIFVector() {
            ...
            FPlane fPlane = MainFactory.getIFPlane(fVector);
        ...
        void setOriginRef() {
            ...
            FPlane fPlane = MainFactory.getIFPlane(fVectorA);
        ...
        void setOriginRefThrowNullPointerException() {
            FPlane fPlane = MainFactory.getIFPlane(RandomHelper.getTestVector());
        ...
        void getOriginValidatePositions() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlane = MainFactory.getIFPlane(fVector.copy());
    ...
    class ICoreFeatures {
        ...
        void parseJSON() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlaneA = MainFactory.getIFPlane(fVector);
            FPlane fPlaneB = MainFactory.getIFPlane().importFromJSON(fPlaneA.exportToJSON());
        ...
        void parseJSONExportValidate() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector());
        ...
        void isExact() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlaneA = MainFactory.getIFPlane(fVector.copy());
            FPlane fPlaneB = MainFactory.getIFPlane(fVector.copy());
        ...
        void isExactFail() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlaneA = MainFactory.getIFPlane(fVector.copy());
            FPlane fPlaneB = MainFactory.getIFPlane(fVector.copy().add(0.5 * jitter));
        ...
        void isExactValidate() {
            FPlane fPlaneA = MainFactory.getIFPlane(MainFactory.getIFVector());
            FPlane fPlaneB = MainFactory.getIFPlane(MainFactory.getIFVector());
        ...
        void isSimilarInverted() {
            FPlane fPlaneA = MainFactory.getIFPlane(RandomHelper.getTestVector());
        ...
        void isSimilarFail() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlaneA = MainFactory.getIFPlane(fVector.copy());
            FPlane fPlaneB = MainFactory.getIFPlane(fVector.copy().moveForward(1.5 * jitter));
        ...
        void isSimilarValidate() {
            FPlane fPlaneA = MainFactory.getIFPlane(MainFactory.getIFVector(0, 1, 0));
            FPlane fPlaneB = MainFactory.getIFPlane(MainFactory.getIFVector(0, 1, 0));
        ...
        void getHashCodeFail() {
            FVector fVector = RandomHelper.getTestVector();
            FPlane fPlaneA = MainFactory.getIFPlane(fVector);
            FPlane fPlaneB = MainFactory.getIFPlane(RandomHelper.getTestVector(fVector));
    ...
    class IFPlaneAdvanced {
        ...
        @DisplayName("Project")
        void project() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(1, 1, 1));
        ...
        void isPartOf() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(1, 1, 1));
            FPoint fPoint = MainFactory.getIFPoint(-1, 2, -1).add(0.5 * jitter);
        ...
        void isPartOfFail() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(1, 1, 1));
            FPoint fPoint = MainFactory.getIFPoint(-1, 2, -1).add(1.5 * jitter);
        ...
        void isInHalfSpace() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(1, 1, 1));
            FPoint fPoint = MainFactory.getIFVector(1, 1, 1)
                    .mul(jitter)
                    .moveBase(-1, 2, -1)
                    .getHead();
        ...
        void isCutA() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(1, 1, 1));
            FVector fVector = MainFactory.getIFVector(1, 1, 1, -1, -1, -1);
        ...
        void getCommonIFPoint() {
            FPlane fPlane = MainFactory.getIFPlane(MainFactory.getIFVector(0, 1, 0));
        ...
        void getCommonIFLine() {
            FVector fVector1 = MainFactory.getIFVector(1, 0, 0);
            FVector fVector2 = MainFactory.getIFVector(1, 0, 0);
            ...
            FPlane fPlane1 = MainFactory.getIFPlane(fVector1);
            FPlane fPlane2 = MainFactory.getIFPlane(fVector2);
        ...
        void getCommonIFLineValidate() {
            FPlane fPlane1 = MainFactory.getIFPlane(RandomHelper.getTestVector());
            FPlane fPlane2 = MainFactory.getIFPlane(RandomHelper.getTestVector());
