package eu.scattering.core.impl.production.debug.stats;
...
public class StatsProd implements Stats {
    ...
    @Override
    public Stats setEnabled(boolean enabled) {
    ...
    @Override
    public Stats recordEvent(String methodName, long methodExecutionTime) {
