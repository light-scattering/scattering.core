package eu.scattering.core.impl.production.engines;
...
public class FRandomProcessorDef implements FRandomProcessor {
    ...
    private final FRandomProcessorCore core;
    ...
    private FRandomProcessorDef() {

        this.core = FRandomProcessorCoreOptimizedDef.create();
    }

    private FRandomProcessorDef(long seed) {

        this.core = FRandomProcessorCoreSimpleDef.create(seed);
    }

    public static FRandomProcessor create() {

        return new FRandomProcessorDef();
    }

    public static FRandomProcessor create(long seed) {

        return new FRandomProcessorDef(seed);
    }
