...
public class FStream3DI implements Buffer<FStream3DI> {
    private static final String JSON_MAIN = "str3DI";
    ...
    private FStream3DI(int[] d0, int[] d1, int[] d2, double[] value) {
    ...
    protected static FStream3DI create(int length) {

        return new FStream3DI(length);
    }

    protected static FStream3DI create(JSONObject json) {
        ...
        int[] d0 = new int[index];
        int[] d1 = new int[index];
        int[] d2 = new int[index];
        ...
        for (int pos = 0, i = 0 ; i < structure.length() ; pos++) {
            d0[pos] = structure.getInt(i++);
            d1[pos] = structure.getInt(i++);
            d2[pos] = structure.getInt(i++);

            value[pos] = structure.getDouble(i++);
        }

        return new FStream3DI(d0, d1, d2, value);
    }
    ...
    public void iterate(FStream3DIConsumer consumer) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof FStream3DI) {
            FStream3DI fStream = (FStream3DI) object;
    ...
    @FunctionalInterface
    public interface FStream3DIConsumer {
