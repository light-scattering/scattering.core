package eu.scattering.core.test.design.main.mutable.number;

import eu.scattering.core.test.design.main.mutable.number.complex.FComplex;
import eu.scattering.core.test.design.main.mutable.number.support.FComplexTestHelper;
...
public class FComplexTest {
    ...
    class BaseMutable {
        ...
        void addFComplexValidate() {
            ...
            FComplexTestHelper.testReference(Number::add, fComplexA, fComplexB);
        }
    ...
    class FComplexAdvanced {
        ...
        public void rootThrowIllegalArgumentException() {
            ...
            Assertions.assertThrows(IllegalArgumentException.class, () -> factory.getHelperRandom().getFComplex().root(-1),
