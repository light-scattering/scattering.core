...
public class FDraftProducerTest {
    ...
    void iterateFixed() {
        ...
        for (FDraft construct : producer.getListFixed(8)) {
    ...
    void iterateRandom() {
        ...
        List<FDraft> results = producer.getListRandomized(60);
    ...
    void stream() {
        ...
        List<FDraft> results = producer.stream().limit(60).collect(Collectors.toList());
