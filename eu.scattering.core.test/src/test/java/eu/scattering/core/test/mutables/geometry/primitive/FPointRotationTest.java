...
public class FPointRotationTest {
    ...
    void rotateSimplePositive() {
        ...
        fPointA.apply(p -> rotation.rotQtAround(p, fPointB, Math.PI));
    ...
    void rotateThrowIllegalArgumentException() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> rotation.rotQtAround(fPointA, fPointB, Math.PI),
    ...
    void rotateValidate() {
        ...
        FPointTestHelper.testReference((a, b) -> rotation.rotQtAround(a, b, Math.PI), fPointA, fPointB);
    }
    ...
    void setAngleSimple() {
        ...
        fPointA.apply(p ->  rotation.setQtAngle(p, fPointB, Math.PI * 0.25));
    ...
    void setAngle() {
        ...
        fPointA.apply(p -> rotation.setQtAngle(p, fPointB, angle));
    ...
    void setAngleValidate() {
        ...
        FPointTestHelper.testReference((a, b) -> rotation.setQtAngle(a, b, Math.PI), fPointA, fPointB);
    }
}
