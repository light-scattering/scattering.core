package eu.scattering.core.test.component.geometry.construct.support;
...
public class FSegmentTestHelper {

    public static void testValue(BiFunction<FSegment, FSegment, Object> exe, FSegment ref, FSegment arg) {
    ...
    public static void testValue(Function<FSegment, Object> exe, FSegment ref) {
        FVector refOriginSnapshot = ref.getRefOrigin();
        FVector refOriginPositionSnapshot = ref.getRefOrigin().copy();
        FPoint refBaseSnapshot = ref.getRefOrigin().getRefBase();
        FPoint refHeadSnapshot = ref.getRefOrigin().getRefHead();
