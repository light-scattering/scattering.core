...
public class FEngineTest {
    ...
    class FEngineBasic {
        ...
        void getSeedEnabled() {
            ...
            FRandom fRandom = factory.getFRandom(seed);
        ...
        void validateRandomizationSeedEnabled() {
            ...
            FRandom fRandom1 = factory.getFRandom(seed);
            ...
            FRandom fRandom2 = factory.getFRandom(seed);
        ...
        void validateRandomizationSeedDisabled() {
            FRandom fRandom1 = factory.getFRandom();

            double val1A = fRandom1.nextDouble();

            FRandom fRandom2 = factory.getFRandom();
    ...
    class FEngineAdvanced {
        ...
        void getPositionOnSphereWithSeed() {
            ...
            FRandom randomB = factory.getFRandom(seed);
        ...
        void getPositionOnSphereWithoutSeed() {
            ...
            FRandom randomB = factory.getFRandom();
            FPos3D posB = randomB.nextDoubleOnSphere(radius);
            FPoint pointB = factory.getFPoint(posB);
