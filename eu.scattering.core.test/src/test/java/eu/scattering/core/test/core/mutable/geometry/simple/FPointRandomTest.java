...
public class FPointRandomTest {
    ...
    void setRandomAngleValidateMagnitude() {
        ...
        FPoint fPoint = factory.getFRandomHelper().rndAngle(factory.getFPoint(radius));
    ...
    void setRandomAngleValidateCorrectness() {
        ...
        FPoint fPointA = factory.getFRandomHelper().rndAngle(factory.getFPoint(radius));
        FPoint fPointB = factory.getFRandomHelper().rndAngle(factory.getFPoint(radius), fPointA);
    ...
    void setRandomAngleValidateTimeout() {
        ...
        Assertions.assertTimeoutPreemptively(Duration.ofSeconds(1), () -> factory.getFRandomHelper().rndAngle(fPoint));
    }
