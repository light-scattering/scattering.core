...
public class FComplexRandomizeTest {
    ...
    void setRandomPositionWithRange() {
        ...
        FComplex results = factory.getFRandEngine().inRange(fComplex, range);
    ...
    void setRandomPositionInCircle() {
        ...
        FComplex results = factory.getFRandEngine().inCircle(fComplex, 0.1);
    ...
    void setRandomPositionOnCircle() {
        ...
        FComplex results = factory.getFRandEngine().onCircle(fComplex, 0.1);
