...
import eu.scattering.cli.aspect.Load;
...
public class Measure implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            FAggregate fAggregate = Load.load(factory, file, format)
            ...
            String results = MeasureService.measure(factory, fAggregate, metrics);
