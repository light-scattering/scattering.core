...
public class FPairPos4D implements Core<FPairPos4D> {
    ...
    protected static FPairPos4D create(JSONObject json) {
        ...
        FPos4D posA = FPos4D.create(structure.getJSONObject(0));
        FPos4D posB = FPos4D.create(structure.getJSONObject(1));
